...
{
    public abstract class SchoolManagementSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SchoolManagementSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SchoolManagementSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SchoolManagementSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SchoolManagementSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SchoolManagementSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SchoolManagementSystemDbContext, Task<T>> func)
        {
            T result;
